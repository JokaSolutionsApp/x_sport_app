...
class _$PreferenceImpl implements _Preference {
  ...
  @override
  String toString() {
    return 'Preference(id: $id, name: $name, options: $options, selected: $selected)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name,
      const DeepCollectionEquality().hash(_options), selected);
...
abstract class _Preference implements Preference {
  const factory _Preference(
          ...
          @JsonKey(name: "name") required final String name,
          @JsonKey(name: "options") required final List<Option> options,
          @JsonKey(name: "selected") required final String selected}) =
      _$PreferenceImpl;
