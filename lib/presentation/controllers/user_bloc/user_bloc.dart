...
import 'package:x_sport/domain/usecase/user_usecase/update_user_preferences_usecase.dart';
import 'package:x_sport/domain/usecase/user_usecase/update_user_profile.dart';
...
class UserBloc extends Bloc<UserEvent, UserState> {
  ...
  UserBloc(
    ...
    on<UpdateUserPreferencesEvent>(_updateUserPreferences);
  ...
  FutureOr<void> _updateUserPreferences(
      UpdateUserPreferencesEvent event, Emitter<UserState> emit) async {
    await updateUserPreferencesUseCase(event.sportId, event.favoriteHand,
        event.favoritePos, event.favoriteTime);
    // result.fold(
    //   (l) => emit(state.copyWith(
    //     userSignInState: RequestState.error,
    //     userSignInMessage: l.message,
