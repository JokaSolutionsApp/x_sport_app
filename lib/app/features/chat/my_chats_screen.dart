...
import 'package:x_sport/app/features/chat/presentation/pages/chat_screen.dart';
        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              controller: tabController,
              children: [
                Center(child: Text('Content for tab 2', style: TextStyle())),
                Center(child: Text('Content for tab 3', style: TextStyle())),
                SizedBox(
                  // height: 0.48.sh,
                  child: Column(
