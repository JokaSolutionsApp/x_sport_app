...
class AddFavoriteSports extends StatefulWidget {
  ...
  @override
  State<AddFavoriteSports> createState() => _AddFavoriteSportsState();
}

class _AddFavoriteSportsState extends State<AddFavoriteSports> {
          ...
          children: [
            ...
            SubmitButton(
              ...
              onPressed: () {
                ...
                final List<int> selectedSport =
                    sportsIds.map((e) => e.sportId).toList();
                context
                    .read<AuthBloc>()
                    .add(AuthEvent.addFavoriteSports(sportsIds: selectedSport));
